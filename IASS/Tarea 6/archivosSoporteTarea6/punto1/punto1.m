...
v1 = [X(1), X(2), X(3), X(4), X(1), X(4), X(5), X(6), X(3), X(6), X(7), X(8), X(5), X(8), X(9), X(7), X(9), X(10), X(11), X(6), X(11), X(12), X(2)];
v2 = [Y(1), Y(2), Y(3), Y(4), Y(1), Y(4), Y(5), Y(6), Y(3), Y(6), Y(7), Y(8), Y(5), Y(8), Y(9), Y(7), Y(9), Y(10), Y(11), Y(6), Y(11), Y(12), Y(2)];
v3 = [Z(1), Z(2), Z(3), Z(4), Z(1), Z(4), Z(5), Z(6), Z(3), Z(6), Z(7), Z(8), Z(5), Z(8), Z(9), Z(7), Z(9), Z(10), Z(11), Z(6), Z(11), Z(12), Z(2)];
plot3(v1,v2,v3)
grid on


% % Después del Euclidian Upgrade
% X1 = InvCP0(1,:); 
% Y1 = InvCP0(2,:);
% Z1 = InvCP0(3,:);
% 
